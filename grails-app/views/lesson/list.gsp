			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="title" title="${message(code: 'lesson.title.label', default: 'Title')}" />
				...
				<g:each in="${lessonInstanceList}" status="i" var="lessonInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${lessonInstance.id}">${fieldValue(bean: lessonInstance, field: "title")}</g:link></td>
